...
// 보기버튼
let buttonA = document.getElementById('A');     //보기1
let buttonB = document.getElementById('B');     //보기2
let buttonC = document.getElementById('C');     //보기3
let buttonD = document.getElementById('D');     //보기4
...
let q = {
    ...
    4 : {'문제':"'애니메이션'이란, '이것'을 뜻하는 라틴어 '아니마'에서 유래되었다. '이것'은 무엇일까요?","정답": "보기4", "해설":"'아니마'영혼을 뜻하는 라틴어다. 애니미즘(Animism)이 여기서 유래된 단어다.", '보기1':'재미', '보기2':'웃음','보기3':'어린이','보기4':'영혼'},
    5 : {'문제':"'이 나무는 세계지도를 감싸고 있는 모양으로 국제기구 UN의 로고로도 쓰입니다. 밤에는 세상을 밝혀주며 상처치료에도 쓰이는 귀한 나무라고 그리스 신화의 아테네 여신이 말했다고 하여 유명한 이 나무의 열매는 지중해식 요리에는 필수 재료로도 쓰이는 나무입니다. 무엇일까요?","정답": "보기1", "해설":"", '보기1':'올리브나무', '보기2':'고무나무','보기3':'버드나무','보기4':'바오밥나무'},    
};
...
function reply_click(clicked_value) {
    ...
    function resultPage() {
        ...
        if (event == answer) {
            ...
            console.log(q[qKey][answer])
            document.querySelector('.correct-answer').innerHTML = q[qKey][answer];
